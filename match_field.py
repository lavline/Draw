...
print("0-100:\t%d(%.*f%%)" % (a1, 2, a1 / length * 100))
print("101-500:\t%d(%.*f%%)" % (a2, 2, a2 / length * 100))
print("501-1K:\t%d(%.*f%%)" % (a3, 2, a3 / length * 100))
print(">1K:\t%d(%.*f%%)" % (a4, 2, a4 / length * 100))
...
plt.show()
fig.savefig('C:/Users/vzt12/Desktop/ACL_experiment/match_eles_'+test_name+'.png', dpi=300)