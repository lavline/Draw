...
#print("0-200:\t%d\t%.*f%%" % (a1, 2, a1 / length * 100))
#print("200-500:\t%d\t%.*f%%" % (a2, 2, a2 / length * 100))
print(">500:\t%d(%.*f%%)" % (a3, 2, a3 / length * 100))
...
ax.scatter(x_index, data, s=5, alpha=0.4)
...
'''
test_name = "65x65x33x33-ipc2-ARM"
plt.title(test_name, size=15)
fig.set_size_inches(5, 3)
plt.show()
fig.savefig('C:/Users/vzt12/Desktop/ACL_experiment/match_cycle_'+test_name+'.png', dpi=300)
